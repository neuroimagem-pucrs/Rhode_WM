...
afni_proc.py \
	...
	-blur_size 6 									\
   	-regress_stim_times 							\
		...
		-regress_opts_3dD							\
			-gltsym 'SYM: +0.5*LeftGreen +0.5*RightRed  -0.5*RightGreen -0.5*LeftRed '		\
 			-glt_label 1 PressLeft_vs_PressRight				\
 			-gltsym 'SYM: +0.5*LeftGreen +0.5*RightGreen  -0.5*LeftRed -0.5*RightRed '		\
 			-glt_label 2 Cong_vs_InCong				\
			-jobs 6										\
			-local_times 								\
